describe "RecordComparer and all subclasses" do
  
  shared_examples "any RecordComparer" do
    ...
    describe "#analyze" do   
      ...
      context "when a small number of records is acceptable" do
        it "removes duplicate records", :details => "RecordComparer.remove_records_with_duplicate_criteria()" do
          @comparer.call_remove_records_with_duplicate_criteria
          remaining = @comparer.chosen
          remaining.size.should eq 3
        end            

        it "removes redundant records", :details => "RecordComparer.remove_redundancies()" do
        ...
        :details => "RecordComparer.supplement_chosen()" do
