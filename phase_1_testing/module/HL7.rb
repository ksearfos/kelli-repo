...
module HL7
  ...
  PID_FIELDS = { :set_id => 1, :patient_id => 3, :patient_name => 5, :mothers_maiden_name => 6,
                 :date_of_birth => 7, :sex => 8, :race => 10, :address => 11, :country_code => 12,
  ...
  OBR_FIELDS = { :set_id => 1, :place_order_number => 2, :filler_order_number => 3, :service_id => 4,
                 :priority => 5, :observation_date_time => 7, :speciment_received_date_time => 14,
                 :specimen_source => 15, :ordering_provider => 16, :order_callback_number => 17,
                 :status_change_date_time => 22, :result_status => 25 }  
